...
$charactaer_rank_url = "https://api.neople.co.kr/cy/ranking/characters/". $characterId4 ."/exp?playerId=&offset=%3Coffset%3E&limit=&apikey=".$api_key;
...
<div class="char_select_div"> 
  <div class="char_select_open">
        <img src="https://img-api.neople.co.kr/cy/characters/<?= $characterId4?>?zoom=2" alt="#">
        <p class="char_name"><?= $characterName4 ?></p>
